...
/**
 * TimedInput — Core input component for the timed entry type module.
 *
 * Full timer application: fixed/unlimited modes, interval bells,
 * warm-up, session recovery, voice reflection, post-session capture.
 */
import {
  CATEGORY_DEFAULTS,
