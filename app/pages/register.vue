...
async function handleRegister() {
  ...
  try {
    ...
    const fetchError = err as { data?: { error?: { message?: string } }; statusMessage?: string };
    const errorMessage = fetchError?.data?.error?.message ?? fetchError?.statusMessage ?? "Registration failed";
