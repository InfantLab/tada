...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold text-stone-800 dark:text-stone-100">Timeline</h1>
        <p class="text-sm text-stone-500 dark:text-stone-400">Your recent entries</p>
      </div>
    ...
    <div v-else-if="entries.length === 0" class="text-center py-12">
      ...
      <p class="text-stone-500 dark:text-stone-400 max-w-md mx-auto mb-6">
        Start capturing moments from your life. Meditations, accomplishments, dreams, habits — everything in one place.
      </p>
    ...
    <div v-else class="space-y-6">
      <div v-for="[date, dayEntries] in groupByDate(entries)" :key="date">
        <h3 class="text-sm font-medium text-stone-500 dark:text-stone-400 mb-3">{{ date }}</h3>
        <div class="space-y-2">
          <div 
