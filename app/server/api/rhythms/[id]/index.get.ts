...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    return {
      ...
      completionMode: rhythm.completionMode,
      durationThresholdSeconds: rhythm.durationThresholdSeconds,
      countThreshold: rhythm.countThreshold,
      chainType: rhythm.chainType,
      chainTargetMinutes: rhythm.chainTargetMinutes,
      journeyThresholdType: rhythm.journeyThresholdType,
      journeyThresholds: rhythm.journeyThresholds,
