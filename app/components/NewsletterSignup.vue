    ...
    <template v-else>
      ...
      <form class="flex gap-2" :class="compact ? '' : 'max-w-md mx-auto'" @submit.prevent="subscribe">
        ...
        <button
          ...
          class="px-5 py-2.5 bg-tada-600 text-stone-900 rounded-lg font-medium hover:bg-tada-700 focus:outline-none focus:ring-2 focus:ring-tada-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm whitespace-nowrap"
        >
